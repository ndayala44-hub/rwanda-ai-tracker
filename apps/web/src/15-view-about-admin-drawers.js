     ...
     ${card("How much of this is real","the platform's own provenance, stated plainly",
      `<div class="prose">
        ...
        <p>Replacing them is a data exercise, not a code one: drop real observations into
          <span class="mono">data/observations.json</span> with <span class="mono">"origin": "source-reported"</span>,
          or POST them to the API. Nothing in the interface changes.</p>
       </div>
   ...
   <div class="row" style="grid-template-columns:1fr 1fr">
     ${card("Methodology versions","",
      `${[["v1.0","12 Mar 2024","Superseded","Initial digitisation of the 2022 framework. Equal weights, linear goalposts, no composite published."],
          ...
          ["v1.2","04 Jun 2026","In force","Partial credit for institutional instruments; capability gates on the maturity ladder; compound indicator OXF12 decomposed; one compute indicator added."]]
